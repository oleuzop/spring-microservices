package oleuzop.services.employee;
...
import oleuzop.services.employee.model.Employee;
import oleuzop.services.employee.repository.EmployeeRepository;
...
public class EmployeeApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("oleuzop.services.employee.controller"))
